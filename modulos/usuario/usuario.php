<div class="content">
    <div class="container">
        <div class="row search-bar">
            <!--barra de busqueda-->
            <div class="col-sm-12">
                <input name="busqueda" id="entrada_busqueda" class="form-control search-input" aria-label="Search" placeholder="Ingresa un nombre o correo para buscar" minlength="1" maxlength="60" type="text">
